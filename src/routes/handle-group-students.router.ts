...
handleGroupStudentsRouter.post("/", verifyToken, verifyTeacher, async (req: Request, res: Response) => {
...
handleGroupStudentsRouter.delete("/:studentId", verifyToken, verifyTeacher, async (_req: Request, _res: Response) => {
